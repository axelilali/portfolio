        ...
        <b-row>
          <b-col>
            ...
            <span data-aos="fade-up" data-aos-delay="300">Find me on
              ...
              >LinkedIn</a></strong>,
              <strong><a
                href="https://github.com/axelilali"
                rel="noopener noreferrer"
                target="blank"
              >Github</a></strong>
              and
            ...
            <a data-aos="fade-up" data-aos-delay="400" class="button" href="mailto:ilali.axel@gmail.com">Let's work
              together</a>
          </b-col>
        </b-row>
      </b-container>
    ...
    <main>
        ...
        <b-container>
          <b-row>
            <b-col>
              ...
              <h3>
                Mbote
                <img height="20" src="~assets/waving-hand.png" alt="Waving hand">
      ...
      <section id="work">
        <div v-for="(client, key) in clients" :key="key" class="client-box">
          <div class="name">
            <img v-if="client.logo" width="150" :src="require('../assets/clients/' + client.logo)" :alt="client.name">
            <p v-else>
              {{ client.name }}
            </p>
          </div>
      ...
      <section id="contact">
        <b-container>
          <b-row>
            <b-col>
              <img data-aos="zoom-in" width="300" src="~assets/me-3.png" alt="Axel Memoji">
              <h2>What's next ?</h2>
              <p>
  ...
  data () {
    return {
      ...
      clients: [
        ...
        {
          name: 'Pavillion Noir',
          desc: 'Built a live streaming SPA using Nuxt and Vimeo API',
          logo: 'pavillion-noir.png'
        },
        {
          name: 'AW Innovate',
          desc: 'Created a real estate custom WordPress theme using Timber framework, Twig & PHP',
          logo: 'aw-innovate.png'
        },
        {
          name: 'Eliette',
          desc: 'Created a custom WordPress theme and job application plugin using Timber framework, Twig & PHP',
          logo: 'eliette.png'
        },
        {
          name: 'Kalda Group',
          desc: 'Built a WordPress website using WPBakery',
          logo: 'kalda.png'
        },
        {
          name: 'Fondation Bulayima',
          desc: 'Built a WordPress website using WPBakery',
          logo: 'fondation-bulayima.png'
        },
        {
          name: 'Blanchard Nzaka & Associés',
          desc: 'Built a Lawyer website using Wix'
        },
        {
          name: 'Mbote Lingala',
          desc: 'Designed UI interfaces for Learning app '
        }
      ]
    }
  },
